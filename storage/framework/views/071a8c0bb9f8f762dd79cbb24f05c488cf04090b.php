	...
	<body>
        ...
        <div class="app">
            <div class="container-fluid ">
            	<div class="row bg-dark align-items-center pt-1 pb-1 ">
      
            		<div class="col-1 col-sm-1 text-center">
            			<a href="<?php echo e(url('/home')); ?>">
    						<i class="fas fa-spider fa-4x mt-2 mb-2 text-primary"></i>        			
    					</a>
                  	</div> 
                    
                    <div class="col-1 col-sm-1 text-center">
						<a href="<?php echo e(url('/home/vue')); ?>" class="btn btn-primary"> Vue.JS</a>
                  	</div> 
                  		        	
                 	<div class="col-6 offset-1 col-sm-6 offset-sm-1">
...
</html><?php /**PATH /Users/Med/Desktop/PERSO/WEB/Laravel5/resources/views/template1.blade.php ENDPATH**/ ?>